                ...
                <div>
                    <table id="tb_product_list" class="table  table-sm table-bordered">
                        ...
                        <template v-for="(item, index) in displayedPosts">
                            ...
                            <td>
                                <span v-show="((cost_lighting == true && set.category == 'Lighting') || (cost_furniture == true && set.category == 'Systems Furniture'))">CP: {{ item.price_ntd }} <br v-if="item.str_price_ntd_change"> {{ item.str_price_ntd_change ?  item.str_price_ntd_change : '' }}<br></span>
