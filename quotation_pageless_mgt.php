            ...
            <div class="tableframe">
                <div class="tablebox lv1">
                    ...
                    <ul v-for='(receive_record, index) in displayedPosts'>
                        ...
                        <li>
                            <button v-show="receive_record.is_edited == 1 && !(receive_record.can_duplicate == 'N' && quotation_control == false) " @click="editRow(receive_record)"><i
                                    class="fas fa-edit"></i></button>
                            <button v-show="receive_record.is_edited == 1 && !(receive_record.can_duplicate == 'N' && quotation_control == false) "  @click="duplicateRow(receive_record)"><i
                                    class="fas fa-copy"></i></button>
                            <button v-show="receive_record.is_edited == 1 && !(receive_record.can_duplicate == 'N' && quotation_control == false) " @click="deleteRow(receive_record)"><i
