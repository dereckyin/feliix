...
switch ($method) {
    ...
    case 'POST':
        ...
        if($type == 'date_needed')
            order_sample_notification02($user_name, 'access1,access2,access3,access4,access5,access6,access7', '', $project_name, $serial_name, $od_name, 'Order - Stocks', $comment, $type, $items_array, $o_id, "stock");
