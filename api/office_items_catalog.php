...
$query = "SELECT d.id, m.code code1, m.category cat1, s.code code2, s.category cat2, b.code code3, b.category cat3, d.code code4, d.category cat4, qty, reserve_qty, d.photo, '' url
