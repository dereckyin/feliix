...
try{
    ...
    if(count($w_items) > 0)
        order_type_notification_warehouse($user_name, 'access1, access3, access4, access5, access7', 'access2', $project_name, $serial_name, $od_name, 'Order - Stocks', $comment, $action, $w_items, $od_id, "stock");
